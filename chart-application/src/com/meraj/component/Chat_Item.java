...
public class Chat_Item extends javax.swing.JLayeredPane {
    ...
    public void sendSuccess() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/com/meraj/icon/tick.png")));
        }
    }

    public void seen() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/com/meraj/icon/double_tick.png")));
        }
    }
    ...
    private void initComponents() {
        ...
        txt = new com.meraj.swing.JIMSendTextPane();
    ...
    private com.meraj.swing.JIMSendTextPane txt;
